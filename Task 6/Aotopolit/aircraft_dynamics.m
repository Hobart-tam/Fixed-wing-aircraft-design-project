...
function sys = mdlDerivatives(t, x, uu, P)
    ...
    gam1 = P.Jxz * (P.Jx-P.Jy + P.Jz)/gamma;%gamma 1
    ...
    attratdot = [gam1*p*q-gam2*q*r;gam5*p*r-gam6*(p^2-r^2);gam7*p*q-gam1*q*r]+[gam3*ell+gam4*n;m/P.Jy;gam4*ell+gam8*n]; % To be completed by students
