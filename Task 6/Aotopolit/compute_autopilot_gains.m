...
UAV.e_phi_max = 15*pi/180;%design parameters
...
UAV.zeta_phi = 3;%design parameters
...
UAV.e_theta_max = 10*pi/180;%design parameter
...
UAV.zeta_theta = 0.7;%design parameter;turning radius
UAV.kd_theta = (2*UAV.zeta_theta*UAV.omega_n_theta-UAV.a_theta1)/UAV.a_theta3;
UAV.K_theta_DC = UAV.kp_theta*UAV.a_theta3/(UAV.a_theta2+UAV.kp_theta*UAV.a_theta3);%week 6 p.36

% altitude
UAV.W_h = 15; %bandwidth separation pitch and altitude;given W:[5,20]
UAV.omega_n_h = (1/UAV.W_h)*UAV.omega_n_theta;
UAV.zeta_h = 1.5;%design parameter
UAV.ki_h = UAV.omega_n_h^2/(UAV.K_theta_DC*UAV.Va0);
UAV.kp_h = (2*UAV.zeta_h*UAV.omega_n_h)/(UAV.K_theta_DC*UAV.Va0);

% airspeed with Pitch
UAV.W_V2 = 8; % bandwidth separation;given W:[5,20]
UAV.omega_n_V2 = (1/UAV.W_V2)*UAV.omega_n_theta;
UAV.zeta_V2 = 707*4; %design parameter
...
UAV.omega_n_V = UAV.omega_n_V2;%design parameter
UAV.zeta_V = 0.7;%design parameter
